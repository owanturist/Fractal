...
const curryResolver = (fn: Function, arity: number, mem: any[]) => (...args: any[]) => {
...
export function curry<T1, T2, T3, T4, R>(fn: (t1: T1, t2: T2, t3: T3, t4: T4) => R): CurriedFunction4<T1, T2, T3, T4, R>;
export function curry<T1, T2, T3, T4, T5, R>(fn: (t1: T1, t2: T2, t3: T3, t4: T4, t5: T5) => R): CurriedFunction5<T1, T2, T3, T4, T5, R>;
export function curry<T1, T2, T3, T4, T5, T6, R>(fn: (t1: T1, t2: T2, t3: T3, t4: T4, t5: T5, t6: T6) => R): CurriedFunction6<T1, T2, T3, T4, T5, T6, R>;
export function curry<T1, T2, T3, T4, T5, T6, T7, R>(fn: (t1: T1, t2: T2, t3: T3, t4: T4, t5: T5, t6: T6, t7: T7) => R): CurriedFunction7<T1, T2, T3, T4, T5, T6, T7, R>;
export function curry<T1, T2, T3, T4, T5, T6, T7, T8, R>(fn: (t1: T1, t2: T2, t3: T3, t4: T4, t5: T5, t6: T6, t7: T7, t8: T8) => R): CurriedFunction8<T1, T2, T3, T4, T5, T6, T7, T8, R>;
export function curry<T1, T2, T3, T4, T5, T6, T7, T8, T9, R>(fn: (t1: T1, t2: T2, t3: T3, t4: T4, t5: T5, t6: T6, t7: T7, t8: T8, t9: T9) => R): CurriedFunction9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R>;
export function curry<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R>(fn: (t1: T1, t2: T2, t3: T3, t4: T4, t5: T5, t6: T6, t7: T7, t8: T8, t9: T9, t10: T10) => R): CurriedFunction10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R>;
export function curry(fn: Function) {
    return curryResolver(fn, fn.length, []);
}
...
export interface CurriedFunction7<T1, T2, T3, T4, T5, T6, T7, R> {
    ...
    (t1: T1, t2: T2): CurriedFunction5<T4, T4, T5, T6, T7, R>;
