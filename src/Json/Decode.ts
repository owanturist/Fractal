...
export namespace Decode {
    ...
    export namespace Error {
        ...
        export const Index: (position: number, error: Error) => Error = cons(class Index extends Error {
            public constructor(
        ...
        export const OneOf: (errors: Array<Error>) => Error = cons(class OneOf extends Error {
        ...
        export const Failure: (message: string, source: unknown) => Error = cons(class Failure extends Error {
            public constructor(
...
export abstract class Error extends Decode.Error {}

export namespace Error {
    export type Pattern<R> = Decode.Error.Pattern<R>;

    export const Field = Decode.Error.Field;

    export const Index = Decode.Error.Index;

    export const OneOf = Decode.Error.OneOf;

    export const Failure = Decode.Error.Failure;
}
